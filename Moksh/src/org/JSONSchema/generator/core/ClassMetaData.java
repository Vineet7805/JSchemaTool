...
public class ClassMetaData {
	...
	public String exportJava(String dirPath,String packageName) throws Exception {
		if("local".equalsIgnoreCase(getScope()) || "api".equalsIgnoreCase(getModelType()))
			return null;
	...
	private String exportLocal(String dirPath,String packageName,Map<String, ClassMetaData> classes) throws Exception {
			...
			for (Property prop : properties) {
				...
				if(!prop.primitive) {
					...
					if("local".equalsIgnoreCase(cmd.getScope())) {
						...
						cmd.exportLocal(dirPath+"/"+cmd.getName(), packageName+"."+cmd.getName(), classes);
	...
	public void exportAPI(String dirPath,String packageName,Map<String, ClassMetaData> classes) throws Exception {	
		exportLocal(dirPath+"/"+getName(),packageName+"."+getName(),classes);
	}
